...
workflow TEST {
	...
	ch_merge_fastq_files = channel.fromPath(params.input).splitCsv().map{
        ...
        //ch_tbi_dbimport  = channel.fromPath(params.input_tbi)
        //                   .splitCsv()
        //                   .collect()
        //                    .toList()
