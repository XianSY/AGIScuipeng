...
**nf-core/OAIP-Genome** is one part of Omics Analysis Integration of Population. Omics Analysis Integration of Population（OAIP） contains FIVE main part，which includes Genome，Transcriptome，Methylome，Phenotype and omics integration. This is the Population Genome resequencing analysis part of OAIP，which includes a common gremline variation calling part and there main analysis flow(GWAS，population genetic analysis and domestication analysis).

![nf-core/OAIP-Genome metro map](docs/images/OAIP-Genome.svg)
...
```bash
nextflow run nf-core/OAIP-Genome \
...
OAIP is written for Multiple Omics Integration analysis supporting of National Major Projects in National Natural Science Foundation of China.
nf-core/OAIP-Genome was originally written by Fan Wei.
